...
package com.d5power.controller
{
	...
	public class CharacterControler extends BaseControler
	{
		...
		protected function calcActionKey():void
		{
			...
			switch(xKey)
			{
				case 1:
					if(yKey==1)
					{
						me.direction = _me.directions.RightDown;
						nextX+=me.speed*_k;
						nextY+=me.speed*_k;
					}else if(yKey==-1){
						me.direction = _me.directions.RightUp;
						nextX+=me.speed*_k;
						nextY-=me.speed*_k;
					}else{
						me.direction = _me.directions.Right;
						nextX=me.PosX+me.speed;
					}
					break;
				case -1:
					if(yKey==1)
					{
						me.direction = _me.directions.LeftDown;
						nextX-=me.speed*_k;
						nextY+=me.speed*_k;
					}else if(yKey==-1){
						me.direction = _me.directions.LeftUp;
						nextX-=me.speed*_k;
						nextY-=me.speed*_k;
					}else{
						me.direction = _me.directions.Left;
						nextX=me.PosX-me.speed;
					}
					break;
				case 0:
					if(yKey==1)
					{
						me.direction = _me.directions.Down;
						nextY=me.PosY+me.speed;
					}else if(yKey==-1){
						nextY=me.PosY-me.speed;
						me.direction = _me.directions.Up;
					}else{
						if(me.action==Actions.Run) me.action = Actions.Wait;
						return;
					}
		...
		protected function onClick(e:MouseEvent):void
		{
			...
			if(clicker!=null && !(clicker is RoadPoint))
			{
		...
		protected function walk2Target():Boolean
		{
			...
			if(WorldMap.AStar==null)
			{
				...
				if(WorldMap.me.roadMap[p.y]==null || WorldMap.me.roadMap[p.y][p.x]!=0)
				{
